...
export type MediaViewerState =
  ...
  | {
      ...
      dmItems?: Array<{ media: { path?: string; kind?: any; fileName?: string } }>;
      gdmItems?: Array<{ media: { path?: string; kind?: any; fileName?: string } }>;
    };
...
export function MediaViewerModal({
  ...
  React.useEffect(() => {
    ...
    setTimeout(() => {
      (viewerScrollRef.current as any)?.scrollTo?.({ x: w * idx, y: 0, animated: false });
    }, 0);
